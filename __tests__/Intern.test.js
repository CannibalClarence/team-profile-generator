...
describe("Intern", () => {
    ...
    describe("Initialization", () => {
        it("Should create an object with a name, id, email address and school if provided valid arguments", () => {
            const intern = new Intern("Theo Phillips", 3, "TheoPhillips@gmail.com", "UW");

            expect(intern.name).toEqual("Theo Phillips");
            expect(intern.id).toEqual(3);
            expect(intern.email).toEqual("TheoPhillips@gmail.com");
