...
describe("Manager", () => {
    ...
    describe("Initialization", () => {
        it("Should create an object with a name, id, email address and office number if provided valid arguments", () => {
            const manager = new Manager("Theo Phillips", 3, "TheoPhillips@gmail.com", "654");

            expect(manager.name).toEqual("Theo Phillips");
            expect(manager.id).toEqual(3);
            expect(manager.email).toEqual("TheoPhillips@gmail.com");
